<template>
  <div>
    <b-breadcrumb>
      ...
      <b-breadcrumb-item active>View Role</b-breadcrumb-item>
    </b-breadcrumb><br>

    <b-card title="View Role">
      <b-row style="margin-bottom:15px;">
        <b-col cols="12">
          ...
          <b-button
            ...
            :to="{name:'role-edit', params: { id: id }}"
          >
            Edit Role
          </b-button>
        </b-col>
...
import { userAccess, viewAccess } from '@/utils/utils.js';
